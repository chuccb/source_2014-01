...
//}} robobeg : 2008-10-18
	...
	{
		int nMajorSeqNum =  g_pX2Game->GetMajorParticle()->GetParticleSequenceNum();
	...
	{		
		int nMinorSeqNum =  g_pX2Game->GetMinorParticle()->GetParticleSequenceNum();
	...
	{		
		int nMajorInstanceNum = g_pX2Game->GetMajorXMeshPlayer()->GetInstanceNum();
	...
	{		
		int nMinorInstanceNum =  g_pX2Game->GetMinorXMeshPlayer()->GetInstanceNum();
...
void CX2ToolView::OnNewDungeon()
{
	...
	if( pMain != NULL )
	{
		pMain->ResetGame(CX2Dungeon::DI_TEMP0);
	}
}
