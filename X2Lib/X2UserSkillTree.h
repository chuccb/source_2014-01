...
public:		/// public function
	...
	bool GetSkillLevelAndCSP( IN CX2SkillTree::SKILL_ID eSkillID, OUT int& iSkillLevel, OUT int& iSkillCSPoint );	// 획득한 스킬이 존재하는지 체크, 있다면 스킬레벨을 return, 없으면 -1 return
	...
	bool IsMaxSkillLevel( CX2SkillTree::SKILL_ID eSkillID );														// 스킬을 최고레벨까지 배웠는지
...
//}} kimhc // 2010.12.14 //  2010-12-23 New Character CHUNG
	...
	// 09.05.30 태완
	int GetSkillEquippedSlotIndex( CX2SkillTree::SKILL_ID eSkillID, bool bSlotB );		// 없으면 -1. 빈칸을 찾고 싶으면 스킬ID를 SI_NONE로 입력하면 된다.
...
#ifdef UPGRADE_SKILL_SYSTEM_2013 // 김태환 - 스킬 시스템 변경
	std::map< CX2SkillTree::SKILL_ID, UserSkillData >& GetMapSkillAcquired() { return m_mapSkillAcquired; }	/// 배운 스킬 목록 반환
