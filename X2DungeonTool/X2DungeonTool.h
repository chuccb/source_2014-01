...
public:
	...
	bool LoadDungeon( CX2Dungeon::DUNGEON_ID dungeonID );
...
private:
	...
	std::map< std::wstring, CX2Dungeon::DUNGEON_ID >	  m_mapDungeonList;
	typedef std::map< std::wstring, CX2Dungeon::DUNGEON_ID >::iterator DungeonListIterator;
