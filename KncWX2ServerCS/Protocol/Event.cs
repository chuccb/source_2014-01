...
/// <summary>System event identifiers copied in declaration order from EventID_System.h.</summary>
...
public sealed class KPerformerInfo
{
    ...
    {
        if (_uids.Count >= MaxUidNum) return false;
        _uids.Add(uid);
        return true;
    }
...
/// <summary>Managed counterpart of Common/Event.h/.cpp.</summary>
public sealed class KEvent
{
    ...
    [
        nameof(SystemEventId.E_HEART_BEAT), nameof(SystemEventId.E_ACCEPT_CONNECTION_NOT),
        nameof(SystemEventId.E_CONNECTION_LOST_NOT), nameof(SystemEventId.E_UDP_PORT_NOT),
        nameof(SystemEventId.E_DISABLE_HB_CHECK_REQ), nameof(SystemEventId.E_LOG_NOT),
        nameof(SystemEventId.E_RESERVE_DESTROY), nameof(SystemEventId.E_TOOL_GET_CCU_INFO_REQ),
        nameof(SystemEventId.E_TOOL_GET_CCU_INFO_ACK), nameof(SystemEventId.E_TOOL_CHECK_LOGIN_REQ),
        nameof(SystemEventId.E_TOOL_CHECK_LOGIN_ACK), nameof(SystemEventId.E_TOOL_SERVER_LIST_REQ),
        nameof(SystemEventId.E_TOOL_SERVER_LIST_ACK), nameof(SystemEventId.E_CHECK_SEQUENCE_COUNT_NOT),
        nameof(SystemEventId.E_UDP_RELAY_SERVER_CHECK_PACKET_NOT), nameof(SystemEventId.E_CONNECT_RELAY_ACK),
        nameof(SystemEventId.E_CHECK_DDOS_GUARD_REQ), nameof(SystemEventId.E_CHECK_DDOS_GUARD_ACK),
    ...
    {
        if (FirstTrace == -1) FirstTrace = uid;
        else LastTrace = uid;
    }

    public void PopTrace()
    {
        if (LastTrace != -1) LastTrace = -1;
        else FirstTrace = -1;
    }
