...
/// <summary>
/// Destination/performer metadata. Native implementation uses std::set,
/// therefore SortedSet is used to preserve deterministic ordering and
/// GetFirstUID() behavior.
/// </summary>
...
/// <summary>
/// Managed counterpart of Common/Event.h/.cpp. Payload bytes are deliberately
/// retained as KSerBuffer until the native Serializer format is ported; this
/// avoids silently inventing a wire format.
/// </summary>
public sealed class KEvent
{
    ...
    {
        return eventId < SystemEventNames.Length
