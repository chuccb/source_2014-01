...
static class Program
{
    ...
    private static void TestSerBuffer()
    {
        ...
        AssertEqual(source.Length, buffer.Length);
        AssertEqual(source.Length, buffer.ReadLength);
    ...
    private static void TestPerformerInfo()
    {
        ...
        AssertEqual(10, clone.GetFirstUid());
    }
    ...
    private static void TestEventTraceAndClone()
    {
        ...
        AssertEqual(ev.Buffer.Length, clone.Buffer.Length);
